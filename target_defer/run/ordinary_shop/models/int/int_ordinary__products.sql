  ...
  create or replace view `dbt-studies-462323`.`ordinary_shop_dbt`.`int_ordinary__products`
  OPTIONS()
  as /*
...
with stg_products as (
    ...
    select * from `dbt-studies-462323`.`ordinary_shop_dbt`.`stg_ordinary__products`
),
