    ...
    create or replace table `dbt-studies-462323`.`ordinary_shop_dbt_prod`.`stg_ordinary__customers_v2`
  ...
  (
    ...
    select customer_sk, customer_id, customer_name, customer_email, updated_at, created_at, loaded_in
    from (
...
with source_data as (
    select 
        ...
        , cast(loaded_at as timestamp) as loaded_in
